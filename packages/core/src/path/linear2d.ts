...
/**
 * Calculates the total arc length of a linear path: the sum of its
 ...
 * decreasing) along its full parameter domain: the brand `solveAtX`
 ...
 * decreasing) along its full parameter domain: the brand `solveAtY`
